...
const DEFAULT_DB: DatabaseSchema = {
  ...
  siteContent: {
    ...
    facebookIntegration: {
      ...
      isLinked: true,
      lastSyncAt: "2026-09-04T12:45:00Z",
      autoSync: true,
      posts: [
        {
          id: "fb-post-1",
...
function sanitizeDbInstance(instance: DatabaseSchema): DatabaseSchema {
  ...
  if (instance && instance.siteContent) {
    ...
    if (!instance.siteContent.facebookPosts || instance.siteContent.facebookPosts.length === 0) {
      instance.siteContent.facebookPosts = DEFAULT_DB.siteContent.facebookPosts;
    }
    if (!instance.siteContent.facebookIntegration) {
      instance.siteContent.facebookIntegration = DEFAULT_DB.siteContent.facebookIntegration;
    }
